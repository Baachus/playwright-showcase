...
test.describe('Inventory Page', { tag: ['@ui'] }, () => {
  ...
  // ── Page load & structure ──────────────────────────────────────────────────
  test('should display the inventory page with the "Products" title', { 
  ...
  test(`should display exactly ${TOTAL_ITEMS} inventory items`, { 
    annotation: [{ type: 'story', description: 'Page Load and Structure' }, 
      { type: 'severity', description: 'normal' }] }, 
      async ({ sd_inventoryPage }) => {
  ...
  test('should display a name, description, and price for every item', { 
    annotation: [{ type: 'story', description: 'Page Load and Structure' }, 
      { type: 'severity', description: 'normal' }] }, 
      async ({ sd_inventoryPage }) => {
  ...
  test('should sort items by name A → Z', { 
  ...
  test('should sort items by name Z → A', { 
    annotation: [{ type: 'story', description: 'Sorting' }, 
      { type: 'severity', description: 'normal' }] }, 
      async ({ sd_inventoryPage }) => {
  ...
  test('should sort items by price low → high', { 
    annotation: [{ type: 'story', description: 'Sorting' }, 
      { type: 'severity', description: 'normal' }] }, 
      async ({ sd_inventoryPage }) => {
  ...
  test('should sort items by price high → low', { 
    annotation: [{ type: 'story', description: 'Sorting' }, 
      { type: 'severity', description: 'normal' }] }, 
      async ({ sd_inventoryPage }) => {
  ...
  test('should add a single item to the cart and update the badge', { 
  ...
  test('should add multiple items and reflect the correct cart count', { 
    annotation: [{ type: 'story', description: 'Cart Interactions' }, 
      { type: 'severity', description: 'normal' }] }, 
      async ({ sd_inventoryPage }) => {
  ...
  test('should remove an item from the cart and decrement the badge', { 
    annotation: [{ type: 'story', description: 'Cart Interactions' }, 
      { type: 'severity', description: 'normal' }] }, 
      async ({ sd_inventoryPage }) => {
    const [firstItem] = await sd_inventoryPage.getAllItems();
  ...
  test('should navigate to the item detail page on name click', { 
  ...
  test('should navigate to the cart page when the cart icon is clicked', { 
    annotation: [{ type: 'story', description: 'Navigation' }, 
      { type: 'severity', description: 'normal' }] }, 
      async ({ page, sd_inventoryPage }) => {
  ...
  test('should log the user out via the burger menu', { 
    annotation: [{ type: 'story', description: 'Navigation' }, 
      { type: 'severity', description: 'normal' }] }, 
      async ({ page, sd_inventoryPage }) => {
  ...
  // ── Social Media Links ─────────────────────────────────────────────────────────────
  test('should navigate to facebook on icon click', { 
  ...
  test('should navigate to twitter on icon click', { 
    annotation: [{ type: 'story', description: 'Social Media Links' }, 
      { type: 'severity', description: 'minor' }] }, 
      async ({ page, sd_inventoryPage }) => {
  ...
  test('should navigate to indeed on icon click', { 
    annotation: [{ type: 'story', description: 'Social Media Links' }, 
      { type: 'severity', description: 'minor' }] }, 
      async ({ page, sd_inventoryPage }) => {
